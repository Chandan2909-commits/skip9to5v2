// Masterclass Crypto Payment Page JavaScript - Skip9to5
...
document.addEventListener('DOMContentLoaded', function () {
    ...
    // Proceed button — validate then show crypto network picker
    document.getElementById('proceedCryptoBtn').addEventListener('click', function () {
    ...
    function confirmPayment() {
        ...
        modalBody.innerHTML = `
            ...
            <form id="transactionForm" class="transaction-form">
                <div class="form-group">
                    ...
                    <p class="form-note">Find this in your crypto wallet after sending</p>
                </div>
        ...
        document.getElementById('transactionForm').addEventListener('submit', function (e) {
            ...
            if (!transactionId) { alert('Please enter a valid transaction hash.'); return; }
