...
document.addEventListener('DOMContentLoaded', function () {
    ...
    function showUPIModal(methodLabel) {
        ...
        // Extract numeric amount from the formatted string (e.g., "₹1,999 ($22)" -> "1999")
        const numericAmount = amount.match(/₹([\d,]+)/)?.[1]?.replace(/,/g, '') || '';
        
        // Generate UPI payment URL with amount pre-filled and note
        // tn = transaction note, mc = merchant code (helps show note field in some UPI apps)
        const upiUrl = `upi://pay?pa=q059150431@ybl&pn=Skip9to5&am=${numericAmount}&cu=INR&tn=skip9to5&mc=5411`;
        ...
        modalBody.innerHTML = `
            ...
            <div class="upi-info">
                ...
                <div class="upi-id">
                    <span id="upiIdText">q059150431@ybl</span>
        ...
        document.getElementById('copyUpiBtn').addEventListener('click', function () {
            navigator.clipboard.writeText('q059150431@ybl').then(() => {
